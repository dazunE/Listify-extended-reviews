<?php
/**
 * Extend reviews system using comment meta
 */

class Extended_comments_review {
	...
	public function pre_get_comments( $query ) {
		...
		} elseif ( 'helpful-desc' == $sort || 'helpful-asc' == $sort ) {

			$query->query_vars['order']    = 'helpful-desc' == $sort ? 'desc' : 'asc';
			$query->query_vars['orderby']  = 'meta_value_num';
			$query->query_vars['meta_key'] = 'helpful_count';
